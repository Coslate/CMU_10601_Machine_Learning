...
\part[4] For this question, we will experiment with the number of sequences seen during training and the effects on performance.
	...
	\centering
	\includegraphics[width=0.55\linewidth]{../handout/Q5_3_training_validation.png}
	\refstepcounter{figure} \\ % Increment the figure counter
	{\tiny \textbf{Figure \thefigure:} Training Loss/Validation Loss vs num\_sequences}  % Manually add a caption/title
	\label{fig:Q5_3_training_validation}         % Label for referencing	
	\end{minipage}
	\newline
	...
	\small
	We can see that training loss is lower than validation loss.
    \end{your_solution}
